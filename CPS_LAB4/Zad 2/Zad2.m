clc;
% Zadanie 2 - Transformata sygnałów rzeczywistych
% 2 N-puntkowe transformacje rzeczywistego sygnału 
% za pomocą jednej N-punktowej transformaty zespolonej
clear all; close all;

% Instrukcja do zadania
figure(1);
Img=imread("Instrukcja21.jpg");
Img=imshow(Img);
figure(2);
Img=imread("Instrukcja22.jpg");
Img=imshow(Img);
